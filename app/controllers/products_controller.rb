...
def index
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :subcategory_id,:initial_price, :selling_price, :bidding_price, :opening_date, :closing_date, product_attachments_attributes:[:id, :product_id, :avatar])
    end
end
